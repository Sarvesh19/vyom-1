...
public class RLPEncoderTest {
	...
	public static class EncodeByteTest extends RLPEncoderTest {
		...
		public static class Module extends JukitoModule {
			...
			protected void configureTest() {
				bindManyInstances(ByteTestData.class, new ByteTestData(
						(byte) 0, "80"), new ByteTestData((byte) 120, "78"),
						new ByteTestData((byte) 127, "7F"), new ByteTestData(
								(byte) 143, "81 8F"));
			}
		}
	...
	public static class EncodeShortTest extends RLPEncoderTest {
		...
		public static class Module extends JukitoModule {
			...
			@Override
			protected void configureTest() {
				bindManyInstances(ShortTestData.class, new ShortTestData(
						(short) 0, "80"), new ShortTestData((short) 120, "78"),
	...
	public static class EncodeIntTest extends RLPEncoderTest {
		...
		public static class Module extends JukitoModule {
			...
			@Override
			protected void configureTest() {
				bindManyInstances(IntTestData.class, new IntTestData(0, "80"),
						new IntTestData(120, "78"), new IntTestData(127, "7F"),

						new IntTestData(1024, "82 04 00"), new IntTestData(
								30303, "82 76 5F"), new IntTestData(20202,
								"82 4E EA"), new IntTestData(65536,
								"83 01 00 00"),
		...
		public static class Module extends JukitoModule {
			...
			protected void configureTest() {
				bindManyInstances(
						...
						new LongTestData((long) Integer.MIN_VALUE,
								"84 80 00 00 00"),
						new LongTestData((long) Integer.MAX_VALUE,
								"84 7F FF FF FF"),
						new LongTestData(0xFFFFFFFFL, "84 FF FF FF FF"),

						new LongTestData(0xBF05138516EL, "86 0B F0 51 38 51 6E"),
						new LongTestData(0x3CC1093F212CL,
								"86 3C C1 09 3F 21 2C"), new LongTestData(
								0xF7D4BD5CC6CB1L, "87 0F 7D 4B D5 CC 6C B1"),
						new LongTestData(0x6BD9D719209BF4L,
								"87 6B D9 D7 19 20 9B F4"), new LongTestData(
								0x877A6F77F0DDA6BL,
								"88 08 77 A6 F7 7F 0D DA 6B"),
						new LongTestData(Long.MIN_VALUE,
								"88 80 00 00 00 00 00 00 00"),
						new LongTestData(Long.MAX_VALUE,
								"88 7F FF FF FF FF FF FF FF"),
						new LongTestData(0xFFFFFFFFFFFFFFFFL,
	...
	public static class EncodeBigIntegerTest extends RLPEncoderTest {
		...
		public static class Module extends JukitoModule {
			...
			protected void configureTest() {
				bindManyInstances(
						...
						BigIntegerTestData.fromDecimal("2147483647",
								"84 7F FF FF FF"),
						BigIntegerTestData
								.fromHex("FFFFFFFF", "84 FF FF FF FF"),

						BigIntegerTestData.fromHex("BF05138516E",
								"86 0B F0 51 38 51 6E"),
						BigIntegerTestData.fromHex("3CC1093F212C",
								"86 3C C1 09 3F 21 2C"),
						BigIntegerTestData.fromHex("F7D4BD5CC6CB1",
								"87 0F 7D 4B D5 CC 6C B1"),
						BigIntegerTestData.fromHex("6BD9D719209BF4",
								"87 6B D9 D7 19 20 9B F4"),
						BigIntegerTestData.fromHex("877A6F77F0DDA6B",
								"88 08 77 A6 F7 7F 0D DA 6B"),
						BigIntegerTestData.fromHex("FFFFFFFFFFFFFFFF",
								"88 FF FF FF FF FF FF FF FF"),

						BigIntegerTestData.fromHex(
								"58e14dd5e30ffd5543220f03ee92cbcc7a692a9e",
								"94 58e14dd5e30ffd5543220f03ee92cbcc7a692a9e"),
						BigIntegerTestData
								.fromHex(
										"a07989f9261f4c8a8b46ec5d98697c4a79e877c2650",
										"96 0a07989f9261f4c8a8b46ec5d98697c4a79e877c2650"),
						BigIntegerTestData
								.fromHex(
										"de0db635daed5b017f273e762ee5c4c9f34a5d33e4107a",
										"97 de0db635daed5b017f273e762ee5c4c9f34a5d33e4107a"),
						BigIntegerTestData
								.fromHex(
										"406e6aee1efb660ceb3d2aa6f6ec4eea1c1439fcff6d4a0c1",
										"99 0406e6aee1efb660ceb3d2aa6f6ec4eea1c1439fcff6d4a0c1"),
		...
		private static class BigIntegerTestData extends TestData {
			...
			private static BigIntegerTestData fromDecimal(String input,
					String expected) {
				return new BigIntegerTestData(new BigInteger(input), expected);
			}

			private static BigIntegerTestData fromHex(String input,
					String expected) {
				return new BigIntegerTestData(new BigInteger(input, 16),
						expected);
			}
		...
		public static class Module extends JukitoModule {
			...
			protected void configureTest() {
				bindManyInstances(
						BytesTestData.class,
						new BytesTestData(
								"4e0117f398a9a9f894a4d49c446e41729ff0cde9bc9",
								"96 04e0117f398a9a9f894a4d49c446e41729ff0cde9bc9"),
						new BytesTestData(
								"87205cf58319be7eb1c6fccc78d0ea15e655ddb519ffe9",
								"97 87205cf58319be7eb1c6fccc78d0ea15e655ddb519ffe9"),
						new BytesTestData(
								"6b19c2ceb52227ceedd4b2f7730772c3364e55055252b8739",
								"99 06b19c2ceb52227ceedd4b2f7730772c3364e55055252b8739"),
						new BytesTestData(
								"63a64bafaebe60847eb13f8be2be0c7747f36359f927d47261b3",
								"9A 63a64bafaebe60847eb13f8be2be0c7747f36359f927d47261b3"),
						...
						new BytesTestData(
								...
								"B9 01 "),
								//\xb9\x02] '
						/* ethereumJ Tests */
						// - Single bytes
